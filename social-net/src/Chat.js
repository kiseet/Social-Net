...
import { useParams, BrowserRouter, useLocation, Link, Route, Navigate } from 'react-router-dom';
...
import { menuItemClasses, MenuList } from '@mui/material';
        ...
        <div style={!roomID ? { display: "none"} : {}} ref={chatAnim} className="chat">
            ...
            <div className="chat__header">
                ...
                <div className="chat__header--right">
                    ...
                    <MenuList
                        ...
                        keepMounted
                    >
                        <menuItemClasses onClick={deleteRoom}>Delete Room</menuItemClasses>
                    </MenuList>
                </div>
            </div>
            ...
            <div className="chat__body--container" ref={chatBodyContainer}>
                <div className="chat__body" ref={chatBodyRef}>
                    ...
                    >
                        {paginateLoader && !limitReached ? <DonutLargeOutlined /> : null}
                    </div>
                            ...
                            <div style={style} ref={i === messages.length - 1 && !(seen && messages[messages.length - 1].uid === user.uid) ? lastMessageRef : null} key={message.id} className={`chat__message ${message.uid === user.uid && "chat__reciever"} ${i === messages.length - 1 ? "chat__lastMessage" : ""}`}>
                                ...
                                {message.imageUrl === "uploading" ?
                                    ...
                                    >
                                        ...
                                        <DonutLargeOutlined style={{ width: page.width <= 760 ? 40 : 80, height: page.width <= 760 ? 40 : 80 }} />
                                        </div>
                                    </div>
                                    : message.imageUrl ?
                                        <div                                       	
